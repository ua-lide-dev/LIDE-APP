<template>
    <!-- Drawer Help -->
    <v-navigation-drawer class="drawer-setting" v-model="helpDrawer" right absolute>
        <v-card outlined tile>
            <v-row>
                ...
                <v-col cols="1">
                    <v-btn class="mt-1 ml-3 text--secondary" @click="closeDrawerHelp" small text>
        ...
        <v-row justify="center">
            <v-col cols="10">
                ...
                <p>Pour tout autre question, UIDE vous invite à contacter votre professeur référent.</p>
            </v-col>
        </v-row>
    </v-navigation-drawer>
</template>
